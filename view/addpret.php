          ...
          <div class="mx-auto col-10 bg-dark container" id="main" style="opacity: 0.9;">
               <form class="w-25 mx-auto mt-5" method="post" action="index.php?action=posting/pret" >
                    <div class="form-group">
                         ...
                         <input name='id_lecteur' type="text" class="form-control"  placeholder="Numéro lecteur" required>
                    </div>
                    <div class="form-group">
                         <label for="Numero_livre">Numéro livre</label>
                         <input name='id_livre' type="text" class="form-control" placeholder="Numéro livre" required>
                    </div>
                    <div class="form-group">
                         <label for="DateR">Dates de retour</label>
                         <input name='date_retour' type="text" class="form-control" placeholder="YY-MM-DD" required>
                    </div>
